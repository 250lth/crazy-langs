...
defmodule CoherenceDemo.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: CoherenceDemo.Coherence.EmailView, layout: {CoherenceDemo.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
