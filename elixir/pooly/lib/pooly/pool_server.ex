defmodule Pooly.PoolServer do
  ...
  defmodule State do
    defstruct sup: nil, size: nil, mfa: nil, monitors: nil, worker_sup: nil, workers: nil, name: nil, pool_sup: nil, max_overflow: nil, overflow: nil, waiting: nil
  end
  ...
  def handle_call({:checkout, block}, {from_pid, _ref} = from, state) do
    ...
    case workers do
      ...
      [] when max_overflow > 0 and overflow < max_overflow ->
        ...
        true = :ets.insert(monitors, {worker, ref})
        {:reply, worker, %{state | overflow: overflow}}
